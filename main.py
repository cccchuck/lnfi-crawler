...
SUPPORTED_TOKENS = ['TREAT', 'TRICK', 'NOSTR', 'BURGER', 'TNA', 'NODE1', 'USDT']
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(description='Lnfi Crawler')
  parser.add_argument('action', choices=['get-orders', 'get-holders'], help='action to perform')
  parser.add_argument('token', choices=SUPPORTED_TOKENS, help='token to get')
